...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('Creating fundraisers and donations tables only...');
    
    // Create fundraisers table
    console.log('Creating fundraisers table...');
    await client.query(`
    ...
    console.log('Inserting sample fundraisers...');
    await client.query(`
    ...
    console.log('Updating fundraiser amounts...');
    await client.query(`
      UPDATE fundraisers 
