...
export default async function handler(req, res) {
  ...
  try {
    ...
    const userQuery = await pool.query('SELECT player_id, email, password_hash, subscription_status, timezone, membership_tier, is_admin, is_club_rep FROM players WHERE email = $1', [email]);
    ...
    const playerResponseData = {
      ...
      is_club_rep: player.is_club_rep || false, // Include club rep status
    };
